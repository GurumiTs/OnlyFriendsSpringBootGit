...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/chatroom.css" />
<link rel="stylesheet"
...
<link rel="icon" type="image/png" sizes="32x32"
	href="${pageContext.request.contextPath}/images/smaillicon/chatroom.png">
...
<body>
	...
	<div class="container-fluid h-100">
			...
			<div class="main row justify-content-center h-100">
				<form id="login-form" name="login-form">
					<div class="input-group">
						<input id="username" type="text" class="form-control all-input"
		...
		<div>
			<p style="color: red" id="hollan">hollan</p>
			<p style="color: red" id="mary">mary</p>
			<p style="color: red" id="kiki">kiki</p>
		</div>
	</div>
