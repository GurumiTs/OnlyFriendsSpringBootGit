...
$('p').on('click', function() {
	...
	console.log("send to :" + selectUser)
})
...
const sendMessage = (event) => {
	...
	if (messageContent && stompClient) {
		...
		const avatarText = document.createTextNode(mymsg.sender[0])
		avatarElement.appendChild(avatarText);
		avatarElement.style['background-color'] = getAvatarColor(mymsg.sender)
		avatarContainer.appendChild(avatarElement)
		messageElement.style['background-color'] = getAvatarColor(mymsg.sender)
		messageElement.innerHTML = mymsg.content
